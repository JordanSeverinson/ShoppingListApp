        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShareCode = table.Column<string>(type: "character varying(11)", maxLength: 11, nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "recipe_shared_permissions",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_recipe_shared_permissions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_recipe_shared_permissions_recipes_RecipeId",
                        column: x => x.RecipeId,
                        principalTable: "recipes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_recipe_shared_permissions_users_UserId",
                        column: x => x.UserId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_recipe_shared_permissions_RecipeId",
                table: "recipe_shared_permissions",
                column: "RecipeId");

            migrationBuilder.CreateIndex(
                name: "IX_recipe_shared_permissions_UserId_RecipeId",
                table: "recipe_shared_permissions",
